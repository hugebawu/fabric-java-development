  ...
  public void initChannel() throws Exception{
    ...
    channel.registerBlockListener(new BlockListener(){
      ...
      public void received(BlockEvent event){
        System.out.format("block No.: %d\n",event.getBlockNumber());
      }
    });
    
    channel.registerChaincodeEventListener(Pattern.compile("wizcc"),Pattern.compile("OnFire"),new ChaincodeEventListener(){
      @Override
      public void received(String handle,BlockEvent blockEvent,ChaincodeEvent chaincodeEvent){
        System.out.format("chaincode event payload: %s\n",new String(chaincodeEvent.getPayload()));
      }
    });
