...
public class App{
  ...
  public void start() throws Exception{
    ...
    System.out.println("register some cars...");
    invoke("wizcc","registerCar",Long.toString(base) + "1","toyota","crown","black","Tommy");
    invoke("wizcc","registerCar",Long.toString(base) + "2","toyota","rav4","white","Mary");
    invoke("wizcc","registerCar",Long.toString(base) + "3","toyota","corolla","white","Jasmine");
    
    System.out.println("query with composite key...");
    query("wizcc","getCarsByBrand","toyota");
  }
